...
func init() {
	logger.SkipFrameContains = append(logger.SkipFrameContains, "commons-db/models")
}
...
// ABACAttribute is the object passed to authorization checks.
// Consumers can extend this with their own types.
