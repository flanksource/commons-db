...
var allConnectionTypes = []string{
	...
	models.ConnectionTypeOpenAI, models.ConnectionTypeOpenTelemetry, models.ConnectionTypeOpenSearch, models.ConnectionTypeOpsGenie,
...
var connectionTypeIcons = map[string]string{
	...
	models.ConnectionTypeOpenTelemetry:  "opentelemetry",
