...
func ProfileSource() Schema {
	paramDef := Schema{
		...
		"properties": Schema{
			...
			"field": Schema{
				...
				"description":        "Backend field this parameter filters on; enables excluding a value and requires an OpenSearch or OpenTelemetry provider",
	...
	return Schema{
		...
		"properties": Schema{
			...
			"params":  Schema{"type": "array", "title": "Params", "items": paramDef, "x-clicky-component": "es-params"},
