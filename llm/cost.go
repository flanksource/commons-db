...
var modelRegistry = map[string]ModelInfo{
	...
	// Claude Code CLI models (use same pricing as underlying Anthropic models)
	"claude-code-sonnet": {
		Provider:            LLMBackendClaudeCode,
	...
	"claude-code-sonnet-3.5": {
		Provider:            LLMBackendClaudeCode,
		ModelID:             "claude-code-sonnet-3.5",
		MaxTokens:           8192,
		ContextWindow:       200000,
		SupportsImages:      true,
		SupportsPromptCache: true,
